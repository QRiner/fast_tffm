...
if mode == 'train' or mode == 'dist_train':
    ...
    if mode == 'train':
        local_train(train_files, weight_files, validation_files, epoch_num, vocabulary_size, vocabulary_block_num,
        ...
        dist_train(ps_hosts, worker_hosts, job_name, task_idx, train_files, weight_files, validation_files, epoch_num,
    ...
    if mode == 'predict':
        local_predict(predict_files, vocabulary_size, vocabulary_block_num, hash_feature_id, factor_num, model_file,
                      score_path)
    else:
        dist_predict(ps_hosts, worker_hosts, job_name, task_idx, predict_files, vocabulary_size, vocabulary_block_num,
